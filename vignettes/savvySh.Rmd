...
-   The **cybersickness dataset** is used for illustrating shrinkage GLMs using a Poisson model. The main Shrinkage GLMs function is part of the related package `ShrinkageGLMs`, you can find [here](https://github.com/Ziwei-ChenChen/ShrinkageGLMs).
